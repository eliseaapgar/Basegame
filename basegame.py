...
class BaseGame:
    def __init__(self, width=800, height=600, title="This is my Game"):
        ...
        self.running = True
        self.FPS = 60
        self.bg_color = (0, 0, 0)  # Default background color: aquamarine
...
"Creating the basics of the game by defining the classes. Test 1 at this point is successful. The game instance is created and prints a confirmation message within the terminal."
...
# Expected Output: Confirmation that Pygame is initialized without errors.

"All tests were successful and confirm that baseclass is fucntioning as expected. Creating further classes and functionality next."
